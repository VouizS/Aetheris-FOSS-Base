...
- fix: (workaround): Codeberg JavaScript error only on Aetheris #1231


### v 19.1 Henry David Thoreau

With this release, it is possible to save settings separate for each website. Look at the WIKI for more Infos: https://www.google.com
...
- new: Aetheris in context menu of marked text #723
