    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            if (sp.getString("showFilterDialogX", "false").equals("true")) {
                ...
                else if (text.equals(sp.getString("icon_07", context.getResources().getString(R.string.color_lime)))) view.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.lime, null));
                ...
                else if (text.equals(sp.getString("icon_10", context.getResources().getString(R.string.color_brown)))) view.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.brown, null));
                else if (text.equals(sp.getString("icon_11", context.getResources().getString(R.string.color_grey)))) view.setBackgroundColor(ResourcesCompat.getColor(context.getResources(), R.color.grey, null));
