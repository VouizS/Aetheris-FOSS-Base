...
Aetheris is fully free/libre (as in freedom) Android app. The source code is public. The app also does not need any unnecessary permissions. It's a simple Android browser based on webview. The intention is to provide a simple and lightweight but a powerful browser with a nice looking user interface.

---

### What are the features of Aetheris?

Aetheris is laced with a variety of rich features that makes it an amazing and outstanding browser. Some of Aetheris features are these;
...
Aside from the features above, Aetheris is designed with all the basic features of a browser. 
...
Bookmarking a webpage on Aetheris is quite simple. First;
...
### Can I browse securely? Does Aetheris support encrypted connections?
...
### What about security? How does Aetheris protect my privacy?

Your privacy is somewhat secured when you use Aetheris. The term somewhat is used because; no method of transmission over the internet or electronic storage is 100% secure, therefore the developer doesn't guarantee its absolute security.

You can read Aetheris [Privacy Policy](https://github.com/scoute-dich/browser/blob/master/PRIVACY.md)
...
Yes, you can download any file on Aetheris. But, the browser would use your device's downloader. 
...
### I found a bug in Aetheris. How can I report it?
